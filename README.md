...
浏览器军旗翻翻棋小游戏，支持**人机对战**（简单/普通/困难/大师四档 AI）与**双人同屏对战**（两人轮流操作）。零依赖、零构建，双击 `index.html` 即玩。
...
- 开局所有棋子背面朝下随机铺满；**你永远先翻第一颗棋子，翻出的颜色决定你的阵营**（若翻到蓝色，则先行移动的是 AI）。双人同屏时任意一方先翻，**先翻者执翻出的颜色**。
